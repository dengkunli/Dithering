...
# another implimentation of error diffusion (Floyd & Steinberg filter)
bin_image_ed = threshold.errorDiffusion(img_gray)
fig5=plt.figure(5)
fig5.suptitle('Error Diffusion: Floyd & Steinberg filter II', fontsize=20)
